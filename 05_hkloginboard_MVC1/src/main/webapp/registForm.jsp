...
<script type="text/javascript">
	onload=function(){ //onload:페이지가 실행되면 기능을 실행하겠다
		//아이디 중복체크를 완료한 후에 다른정보를 입력할 수 있게 처리
		//입력박스에 입력하기 전에 idChk=y,n여부를 확인해서 y이면 입력실행, n이면 id입력 박스로 포커스
		var inputs=document.querySelectorAll("input[name]");
		var idChks=document.getElementById("idChk");
		for(var i=2; i<inputs.lenght;i++){
