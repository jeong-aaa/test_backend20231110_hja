...
//         response.sendRedirect("board/insertBoardForm.jsp");
         ...
         out.print(str);
      }else if(command.equals("/error.board")) {
          ...
          if(isS) {
         	 		...
         	 		str=jsForward("글 수정 실패","error.board?msg=글 수정 실패");
          }
          out.print(str);
    	  ...
    	  String str="";
    	  if(isS) {
    		  str=jsForward("글 삭제 성공", "boardList.board");
    	  }else {
    		  str=jsForward("글 삭제 실패","error.board?msg=글 삭제 실패");
    	  }
    	  out.print(str);
