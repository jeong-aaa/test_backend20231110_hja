...
//	}else{
		...
		if(isS){
			response.sendRedirect("hkController.jsp?command=boardList");//boardList에는 dao가 없기때문에 controller를 들렸다 가야함
		}else{
			response.sendRedirect("error.jsp?msg="+URLEncoder.encode("여러글 살제 실페","utf-8"));
		}
//	}
	}
%>
