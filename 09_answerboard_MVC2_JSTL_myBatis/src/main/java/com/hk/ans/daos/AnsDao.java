...
public class AnsDao extends SqlMapConfig {
   ...
   public String namespace="com.hk.ans.";
...
//      
//      try {
//         //sqlSessionFactory객체의 openSession()을 통해서 sqlSession객체를 구함
//         //true:autocommit으로 설정
...
//         dto=sqlSession.selectOne(namespace+"getBoard",seq);
   ...
   public void test() {
      ...
      List<AnsDao>list=sqlSession.selectList("boardList");
   }
}
