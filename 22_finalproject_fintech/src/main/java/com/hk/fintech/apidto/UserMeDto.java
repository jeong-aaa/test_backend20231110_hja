...
public class UserMeDto {
   ...
   public UserMeDto() {
	...
	public UserMeDto(String api_tran_id, String api_tran_dtm, String rsp_code, String rsp_message, String user_seq_no,
			String user_ci, String user_name, String user_info, String user_gender, String user_cell_no, String user_email,
			String res_cnt, List<UserMeAccountDto> res_list) {
		super();
	...
	public String toString() {
		return "UserMeDto [api_tran_id=" + api_tran_id + ", api_tran_dtm=" + api_tran_dtm + ", rsp_code=" + rsp_code
				+ ", rsp_message=" + rsp_message + ", user_seq_no=" + user_seq_no + ", user_ci=" + user_ci + ", user_name="
				+ user_name + ", user_info=" + user_info + ", user_gender=" + user_gender + ", user_cell_no=" + user_cell_no
				+ ", user_email=" + user_email + ", res_cnt=" + res_cnt + ", res_list=" + res_list + "]";
	}
