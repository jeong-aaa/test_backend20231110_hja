...
public class UserDto {
 ...
 //제발
   public UserDto() {
	...
	public UserDto(String username, String useremail, String userpassword, String delflag, String useraccesstoken,
	...
	public String toString() {
		return "UserDto [username=" + username + ", useremail=" + useremail + ", userpassword=" + userpassword
				+ ", delflag=" + delflag + ", useraccesstoken=" + useraccesstoken + ", userrefreshtoken="
